...
st.set_page_config(page_title="Census Dashboard", page_icon="static/images/favicon.png", layout="wide")
...
# st.markdown(open("templates/footer.html", "r+").read(), unsafe_allow_html=True)

# ---- SIDEBAR ----
# st.sidebar.header("Please Filter Here:")
# city = st.sidebar.multiselect(
#     "Select the City:",
#     options=df["Townland"].unique(),
#     default=df["Townland"].unique()
# )
#
